...
Copilot's second round found two more escapes, fixed test-first in a fourth slice (`claude/enforce/tests/commit-message-guard-copilot-round2.test.sh`, test-author agent):
