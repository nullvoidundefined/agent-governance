...
**Why the behavioural anchor is in the same fixture.** The greps are a proxy for the real property. If someone reaches for a bash 4 construct the list does not name, the greps pass and the anchor is the thing that still fails.
