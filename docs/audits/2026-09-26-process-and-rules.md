...
- **Composition leans structural.** Commits touching `claude/enforce/hook-hashes.txt` rose from 56% of the baseline window to 66%. Commits touching generated `codex/` or `cursor/` output rose from 35% to 45%. All eight fixes on 2026-09-24 repaired harness machinery, five of them machinery added in the preceding seven days.
