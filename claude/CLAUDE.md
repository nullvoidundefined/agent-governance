...
R-105: Obtain explicit confirmation before any destructive MCP action (delete, drop, rotate, send, post, create) unless pre-authorized this turn or named as a tool of the active ticket tracker in `TICKET-TRACKER.json`. [hook:mcp-action-guard]
