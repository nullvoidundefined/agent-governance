...
- `autoDraftPr` (R-517): `false` stops `hooks/draft-pr-on-first-push.sh` from opening a draft pull request after a push. Absent or any other value leaves the hook on.
