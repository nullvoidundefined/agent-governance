...
R-105: Obtain explicit confirmation before any destructive MCP action (delete, drop, rotate, send, post, create) unless pre-authorized this turn; private-tracker writes are exempt unless they land code, submit, upload, or apply.
