...
R-517: Open a draft PR as soon as a non-default branch that has never had a PR is pushed, and turn on the desktop app's PR monitor for every PR that opens.
