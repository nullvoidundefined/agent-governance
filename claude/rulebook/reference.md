...
R-514: Never merge a PR without explicit user authorization in the current turn.
  ...
  - Default path: (1) CI passes; (2) Copilot review passes, except for a trivial-tier PR, which requests no Copilot review and merges on green CI (IAN-98, 2026-09-18); (3) the user explicitly asks to merge after both are confirmed green. "Merge when ready" is not authorization.
