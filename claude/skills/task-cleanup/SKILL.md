...
6. Never request a second Copilot round. After a behavior-changing fix, re-run the Codex review on the new range; wording, docs, and PR-description fixes merge on green CI without a re-review.
