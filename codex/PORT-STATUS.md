...
50 of 53 hook registrations port, across 6 Codex events.
...
| `task-state-tracker` | PostToolUse (TaskCreate|TaskUpdate) | ported: `PostToolUse` (matcher `TaskCreate|TaskUpdate`) |
