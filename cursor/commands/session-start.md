...
5. Confirm Cursor loaded the project `.cursor/rules/`; read it only when its content is absent from context. A repo with none lists `no project file` under Skipped.
