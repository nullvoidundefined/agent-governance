...
---
<!-- Cloned from claude/skills/tdd-gated-dispatch/SKILL.md. Do not edit here; change the source and re-copy; enforce/tests/skills-lint.test.sh fails when this copy drifts. -->
